  ...
  render() {
    ...
    return (
      ...
      <div className="container">
        ...
        <br />
        <div className="row">
          <h2 className=" mx-auto d-block  whiteText">{this.state.fname}{" "}{this.state.lname}</h2>
          <br />
        </div>
        <div className="row">
          <span className="mx-auto d-block whiteText">
            Member since {this.state.membersince} <br />
          </span>
        </div>
        <br />
        <br />
