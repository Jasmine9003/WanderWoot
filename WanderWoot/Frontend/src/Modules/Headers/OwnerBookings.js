     ...
     properties = this.state.properties.map(property => {
      ...
      return(
        ...
        <div className="card-body">
          <h5 className="card-title">From {this.getFormattedDate(moment(property.from))} to {this.getFormattedDate(moment(property.to))} </h5>
          <p className="card-text"> @ your Property in <b>{property.city}</b></p>
          <p className="card-text">Rent: <b>{property.cost}{property.currency}</b></p>
